               ...
               <div class="form-group col-lg-4"> 
                ...
                <div class="form-group col-lg-4">
                 <div class="col-xm-3" style="">
                  <div class="card" style="width: 18rem;">
                    <div class="card-body">
                      <h5 class="card-title">View Student Record</h5>
                      <p class="card-text">Used for Viewing Student Records.</p>
                      <br>
                      <a href="student_view.php" class="card-link">Proceed</a>
                    </div>
                  </div>
                 </div>
                </div>
                 ...
                 <div class="col-xm-3" style="">
                  <div class="card" style="width: 18rem;">
                    <div class="card-body">
                      ...
                      ?>
                      <img style="float:left;" src="student.jpg">
                      <span style="font-size:50px;float:right;height:10px;"><?php echo $row?></span><br><br><br>
                      <p class="card-text" style="float:right;">Total Students.</p>
                    </div>
                  </div>
                 </div>
                </div>
